...
class TodayTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final prayers = PrayerCalculator.calculatePrayerTimes(currentTime);
    final nextPrayer = PrayerCalculator.getNextPrayer();
    final now = TimeOfDay.now();

    return CustomScrollView(
      slivers: [
        SliverAppBar(
          expandedHeight: 240, // INCREASED from 220 to 240 to accommodate content
          pinned: true,
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Flexible( // ADDED to prevent location text overflow
                                      child: Text(
                                        location,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FittedBox(
                                    ...
                                    child: Text(
                                      PrayerCalculator.getTimeUntilNextPrayer(),
                                      style: const TextStyle(
                                        color: Colors.white,
                                        fontSize: 20,
                                        fontWeight: FontWeight.bold,
